...
export default function SearchBox() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto flex flex-col items-center">
      ...
      {loading ? (
        <div className="mt-4 p-4 max-w-xl mx-auto w-full">
        ...
        <div className="mt-4 space-y-3 max-w-xl mx-auto w-full">
          {results.map((sound) => (
            <div key={sound.id} className="bg-[#1a1a1a] rounded-xl p-3 flex flex-col gap-2 border border-gray-800/50 hover:border-gray-700/50 transition-colors">
              ...
              <audio 
                controls 
                className="w-full h-8 [&::-webkit-media-controls-panel]:bg-[#3C3C3E] [&::-webkit-media-controls-current-time-display]:text-white [&::-webkit-media-controls-time-remaining-display]:text-white"
              >
